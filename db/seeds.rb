...
# MedicalHistory.create!(patient_id: patient1.id, weight: 180, blood_pressure: '120/80', blood_sugar: '110', temperature: 98.6, pulse_rate: 80, test: 'X-ray', diagnosis: 'Flu', medication: 'Ibuprofen', notes: 'Patient has been experiencing fever and cough')
# MedicalHistory.create!(patient_id: patient1.id, weight: 175, blood_pressure: '115/78', blood_sugar: '105', temperature: 99.1, pulse_rate: 82, test: 'Blood test', diagnosis: 'Anemia', medication: 'Iron supplements', notes: 'Patient has been feeling tired and short of breath')
# MedicalHistory.create!(patient_id: patient2.id, weight: 130, blood_pressure: '110/75', blood_sugar: '100', temperature: 98.4, pulse_rate: 75, test: 'MRI', diagnosis: 'Migraine', medication: 'Ibuprofen', notes: 'Patient has been experiencing headache and nausea')
# MedicalHistory.create!(patient_id: patient2.id, weight: 140, blood_pressure: '115/80', blood_sugar: '110', temperature: 98.9, pulse_rate: 77, test: 'EKG', diagnosis: 'Heart palpitations', medication: 'Atenolol', notes: 'Patient has been feeling chest pain and shortness of breath')
# MedicalHistory.create!(patient_id: patient3.id, weight: 160, blood_pressure: '125/85', blood_sugar: '115', temperature: 99.3, pulse_rate: 79, test: 'Ultrasound', diagnosis: 'Kidney stones', medication: 'Pain medication', notes: 'Patient has been experiencing back pain and frequent urination')
# MedicalHistory.create!(patient_id: patient3.id, weight: 155, blood_pressure: '120/82', blood_sugar: '110', temperature: 98.7, pulse_rate: 81, test: 'CT scan', diagnosis: 'Appendicitis', medication: 'Antibiotics', notes: 'Patient has been experiencing abdominal pain and vomiting')
# MedicalHistory.create!(patient_id: patient4.id, weight: 145, blood_pressure: '115/78', blood_sugar: '105', temperature: 98.5, pulse_rate: 76, test: 'Sputum culture', diagnosis: 'Pneumonia', medication: 'Antibiotics', notes: 'Patient has been experiencing cough and shortness of breath')
# MedicalHistory.create!(patient_id: patient4.id, weight: 150, blood_pressure: '120/80', blood_sugar: '110', temperature: 98.8, pulse_rate: 78, test: 'X-ray', diagnosis: 'Bronchitis', medication: 'Antibiotics', notes: 'Patient has been experiencing cough and fatigue')
# MedicalHistory.create!(patient_id: patient5.id, weight: 170, blood_pressure: '125/85', blood_sugar: '115', temperature: 99.1, pulse_rate: 80, test: 'Blood test', diagnosis: 'High cholesterol', medication: 'Atorvastatin', notes: 'Patient has a family history of heart disease')
# MedicalHistory.create!(patient_id: patient5.id, weight: 165, blood_pressure: '120/82', blood_sugar: '110', temperature: 98.9, pulse_rate: 82, test: 'EKG', diagnosis: 'Arrhythmia', medication: 'Beta blockers', notes: 'Patient has been experiencing palpitations and dizziness')
# MedicalHistory.create!(patient_id: patient5.id, weight: 160, blood_pressure: '115/78', blood_sugar: '105', temperature: 98.7, pulse_rate: 84, test: 'Ultrasound', diagnosis: 'Gallstones', medication: 'Pain medication', notes: 'Patient has been experiencing abdominal pain and nausea')
# MedicalHistory.create!(patient_id: patient5.id, weight: 155, blood_pressure: '110/75', blood_sugar: '100', temperature: 98.5, pulse_rate: 86, test: 'CT scan', diagnosis: 'Pancreatitis', medication: 'Antibiotics', notes: 'Patient has been experiencing abdominal pain and vomiting')
# MedicalHistory.create!(patient_id: patient5.id, weight: 150, blood_pressure: '105/70', blood_sugar: '95', temperature: 98.3, pulse_rate: 88, test: 'MRI', diagnosis: 'Herniated disc', medication: 'Muscle relaxants', notes: 'Patient has been experiencing back pain and numbness in limbs')
